...
class Voicechat(commands.Cog):
    ...
    async def on_voice_state_update(self, member, before, after):
        if after.channel and not before.channel and after.channel.name == "Voice Erstellen":
            async with aiosqlite.connect("voice_channels.db") as db:
                ...
                if not channel_info:
                    ...
                    category = after.channel.category  # Use the same category as the "Custom Channel erstellen" channel
