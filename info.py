...
class Info(commands.Cog):
    ...
    async def on_message(self, message):
        ...
        if self.bot.user in message.mentions:
            ...
            embed.add_field(name="⚙️ | Entwickler", value="<@397777058727460875> [The1AndOni]", inline=False)
            ...
            embed.set_footer(text="TheOneAndOni", icon_url=self.bot.user.avatar.url)

            embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/1030184823182069791/1138463219841761280/DbD-The-Oni.jpeg") #Wenn du einen Link benutzt kannst du attachment://Boticon.png weglassen und in denn "LINK" einfach denn Link einfügen, ansonst oben denn Filenamen angeben denn du oben bei filename hinzugefügt hast und davor attachment:// schreiben
